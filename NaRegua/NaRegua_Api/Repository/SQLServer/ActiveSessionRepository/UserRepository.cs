...
namespace NaRegua_Api.Repository.SQLServer.ActiveSessionRepository
{
    public class UserRepository : UserRepositorySQLServer
    {
        ...
        protected override string DELETE_AVAILABILITY_FROM_PROFESSIONAL =>
            "DELETE FROM AVAILABILITY_PROFESSIONALS WHERE PROFESSIONAL_DOCUMENT = @PROFESSIONAL_DOCUMENT AND CAST([DATETIME] AS VARCHAR(30)) = CAST(@DATE AS VARCHAR(30))";
        ...
        protected override string SELECT_AVAILABILITY_AND_INFOs_FROM_PROFESSIONAL =>
            ...
            "WHERE A.PROFESSIONAL_DOCUMENT = @PROFESSIONAL_DOCUMENT AND CAST(A.[DATETIME] AS VARCHAR(30)) = CAST(@DATE AS VARCHAR(30))";
        ...
        protected override string INSERT_SCHEDULING_FROM_PROFESSIONAL => "INSERT INTO SCHEDULING_PROFESSIONALS VALUES (@PROFESSIONAL_DOCUMENT, @CLIENT_NAME, @CLIENT_PHONE, @DATE)";
    }
}
