...
{
    public class HairdresserRepositorySqlServer : HairdresserRepository
    {
        ...
        protected override string SELECT_HAIRDRESSERS_AVAILABILITY =>
            "SELECT DISTINCT * FROM [AVAILABILITY_PROFESSIONALS] WHERE PROFESSIONAL_DOCUMENT = @DOCUMENT";
        ...
        protected override string SELECT_HAIRDRESSERS_EVALUATION_AVERAGE =>
            "SELECT PROFESSIONAL_DOCUMENT, AVG(EVALUATION) " +
